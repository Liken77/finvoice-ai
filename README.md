...
A base da DIO foi mantida com sua arquitetura em camadas e isolada neste repositório para facilitar leitura, execução e avaliação. Como evolução, foi criado um resumo financeiro com total geral e totais por categoria, além de validações para transações e arquivos de áudio.
